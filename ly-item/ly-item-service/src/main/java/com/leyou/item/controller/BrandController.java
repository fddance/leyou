...
public class BrandController {
    ...
    @GetMapping("/list")
    public ResponseEntity<List<Brand>> queryBrandListByIds(@RequestParam("idList") List<Long> idList){
        return ResponseEntity.ok(brandService.queryBrandListByIds(idList));
    };
}
